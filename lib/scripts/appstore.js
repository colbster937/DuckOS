...
const config = [
    ...
    function1: () => {
      const kahootFlooderApp = `
          <iframe src="https://kahoot.colbster937.dev" frameborder="0" style="width: 100%; height: 100%; border: none; margin: none;"></iframe>
        `
      const kahootFlooder = {
        id: 5,
        imageSrc: '../media/icons/kahoot.webp',
        ...
        clickFunction: function() {
          createWindow('Kahoot Flooder | Colbster937', kahootFlooderApp, '60%', '90%');
        }
      };
      createApp(notes);
