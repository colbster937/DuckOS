...
function hideAppStoreOnClickOutside(event) {
    if (!appstore.contains(event.target) && event.target !== appstoreToggle) {
        hideAppStore();
    }
}
const config = [{
        imageSrc: '/media/icons/spotify.png',
        title: 'Spotify',
        description: 'The owner of DuckOS\'s favorite app to listen to Music',
        function1: () => {
            const spotifyApp = `
<iframe src="https://open.spotify.com" frameborder="0" style="width: 100%; height: 100%; border: none; margin: none;"></iframe>
`
            const spotify = {
                id: 5,
                imageSrc: '/media/icons/spotify.png',
                ...
                clickFunction: function() {
                    createWindow('Spotify', spotifyApp, '50%', '60%');
                }
            };
            createApp(spotify);

            console.log('Successfully installed the app "Spotify" with the ID of "5".');
        },
        function2: () => {
            removeAppById(5);
            console.log('Successfully uninstalled the app "Spotify" with the ID of "5".');
        },
        buttonTexts: ['Install Spotify', 'Uninstall Spotify']
    },
    {
        ...
        `
            ...
            createApp(notes);
            console.log('Successfully installed the app "Notes" with the ID of "6".');
        },
        function2: () => {
            removeAppById(6);
            console.log('Successfully uninstalled the app "Notes" with the ID of "6".');
        },
