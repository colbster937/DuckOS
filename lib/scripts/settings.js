...
document.addEventListener("DOMContentLoaded", function() {
  ...
  lightmodeSwitch.addEventListener("change", function() {
      const elementsToModify = document.querySelectorAll('div:not(.background-img):not(#rows):not(.row):not(.info):not(#appsContainer):not(.topbar):not(.settings-container):not(#taskbar):not(.notification-container), #time');
